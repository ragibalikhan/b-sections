...
import { Card, Collapsible, TextContainer, Button, TextField, ColorPicker, Stack } from '@shopify/polaris';
    ...
    <Card title="Customize FAQ Section" sectioned>
      <Stack vertical>
        ...
        <Card sectioned title="Customize Styling">
          <Stack vertical>
            <div>
              <TextContainer>Background Color</TextContainer>
              <ColorPicker onChange={setBackgroundColor} color={backgroundColor} />
            </div>
            <div>
              <TextContainer>Text Color</TextContainer>
