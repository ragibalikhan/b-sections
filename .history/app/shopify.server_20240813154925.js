...
import { RestClient } from "@shopify/shopify-api/lib/clients/rest"; // Import RestClient directly
...
const createRecurringCharge = async (session) => {
  ...
  const client = new RestClient(shop, accessToken); // Use RestClient here
